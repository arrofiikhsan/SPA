...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "text-center", staticStyle: { margin: "20px 0" } },
      [
        _c("span", { staticClass: "text-secondary" }, [
          _vm._v("Book App with Laravel and Vue JS")
        ])
      ]
    )
  }
...
!(function webpackMissingModule() { var e = new Error("Cannot find module './components/AllBooks.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module './components/AddBook.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module './components/EditBook.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var routes = [{
  name: 'home',
  path: '/',
  component: !(function webpackMissingModule() { var e = new Error("Cannot find module './components/AllBooks.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
}, {
  name: 'add',
  path: '/add',
  component: !(function webpackMissingModule() { var e = new Error("Cannot find module './components/AddBook.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
}, {
  name: 'edit',
  path: '/edit/:id',
  component: !(function webpackMissingModule() { var e = new Error("Cannot find module './components/EditBook.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
}];
...
__webpack_require__(/*! c:\wamp64\www\BookApp\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! c:\wamp64\www\BookApp\resources\sass\app.scss */"./resources/sass/app.scss");
